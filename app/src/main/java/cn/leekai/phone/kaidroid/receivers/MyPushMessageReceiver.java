package cn.leekai.phone.kaidroid.receivers;
...
/**
 * description：百度推送回调页面（通过kailib传递过来）
 * created on：2018/1/19 16:16
 * @author likai
 */
public class MyPushMessageReceiver extends PushMessageReceiver {
	public static final String TAG = "K_PUSH";
	...
	public void onBind(Context context, int errorCode, String appid, String userId, String channelId, String requestId) {
		...
		// onBind errorCode=0 appid=4360679 userId=596900631714392432 channelId=4295009804668811866 requestId=4050124148
		if (errorCode == 0) {
			KaiCore.getConfig().setBaiduChannelId(channelId);
	...
	public void onNotificationClicked(Context context, String title, String description, String customContentString) {
		...
		if (!StringUtils.isBlank(description)) {
			// do something
			ToastUtils.showToast("点击了notification");
		}
	}

	@Override
	public void onNotificationArrived(Context context, String title, String description, String customContentString) {
		String notifyString = "通知到达 title=\"" + title + "\" description=\"" + description + "\" " + "s2=" + customContentString;
		LogUtils.d(TAG, notifyString);

		//增加桌面图标角标
		AppUtils.showShortcutBadger();
	}
